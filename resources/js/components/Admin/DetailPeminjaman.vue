<template >
    ...
    <div class="card shadow">
          ...
          <div v-show="detail_peminjaman.status_peminjaman == 'belum dikembalikan' && detail_peminjaman.status_pinjam == 'belum dipinjam'  ">
                    <button class="btn btn-danger" @click="batalkanPeminjaman()" >batalkan peminjaman</button>
          </div>
...
export default {
 ...
 //                   this.kodeid = id_peminjaman
        ...
        batalkanPeminjaman(){
          var vm = this;
          axios.get('http://localhost:8000/operator/batalkanpeminjaman/'+vm.$route.params.id_peminjaman)
            .then(function (resp){
